...
ParkAlert India is maintained as a portfolio project and Real Firebase mode requires an owner-supplied local configuration; the repository test is currently a placeholder smoke test.
